// Allow macro to repeat multiple times 
measureAgain = 1
while ( measureAgain == 1) {
	...
	//Ask user whether they would like to run the macro again 
	measureAgain = getBoolean("Would you like to make another set of measurements?");
